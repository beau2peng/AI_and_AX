[English](llm_sum_error_and_search_executor_en.md)
...
처음에는 몇 개의 숫자를 더했는데 결과가 이상해서 Excel을 열어 다시 계산해본 것이 시작이었습니다. 그 작은 오류를 따라가면서 Rollup을 만들었고, 여러 Search를 처리하는 방법까지 다시 고민하다 보니 Executor도 하나 생겼습니다. 계획했던 기능은 아니었지만 결과적으로 AITOOL에서 LLM과 서버의 역할을 조금 더 명확하게 나누는 계기가 되었습니다.
